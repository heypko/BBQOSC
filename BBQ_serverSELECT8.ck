...
9 => int endCHAN;                   // Audio Channel End Index
...
fun void playLight() // ,
{
    ...
    sndbufArray[sbc] => ADSR e_light => Pan8 p_light => dac.chan(finalCHAN);
...
fun void playMedium() // .
{
    ...
    sndbufArray[sbc] => ADSR e_medium => Pan8 p_medium => dac.chan(finalCHAN);
...
fun void playHeavy() // .
{
    ...
    sndbufArray[sbc] => ADSR e_heavy => Pan8 p_heavy => dac.chan(finalCHAN);
